...
// Reuse existing LanguageProvider and i18n test
shell.mv(
  'app/containers/LanguageProvider/test',
  'internals/templates/containers/LanguageProvider',
);
shell.cp('app/test/i18n.test.js', 'internals/templates/test/i18n.test.js');
...
// Handle test/
shell.mv('internals/templates/test', 'app');

// Handle intl/
shell.rm('-rf', 'app/intl');
shell.mv('internals/templates/intl', 'app');
...
shell.cp('internals/templates/i18n.js', 'app/www/intl/i18n.js');
