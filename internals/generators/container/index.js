...
module.exports = {
  ...
  actions: data => {
    ...
    // reducer.js and the corresponding test for actions and the reducer
    if (data.wantActionsAndReducer) {
      ...
      actions.push({
        type: 'add',
        path:
          '../../app/containers/{{properCase name}}/test/selectors.test.js',
    ...
    if (data.wantSaga) {
      ...
      actions.push({
        type: 'add',
        path: '../../app/containers/{{properCase name}}/test/saga.test.js',
